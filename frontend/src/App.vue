...
// 统一视图的列表行会标注邮件所属邮箱，这里复用同一套服务商图标。
const mailAccountEmail = (item:Mail) => item.account || accountEmail(item.accountId)
const mailLogo = (item:Mail) => providerIcon(mailAccountEmail(item))
